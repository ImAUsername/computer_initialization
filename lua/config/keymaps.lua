...
-- This is for `VimL` format vs `Lua` format below.  We do not use these and use the Lua format below.
vim.cmd([[
...
local config_keymap = {
  ...
  {"n", "<leader>bo", function() Snacks.bufdelete.other() end, { desc = "Delete Other Buffers" }},
